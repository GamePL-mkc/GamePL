...
# Спасибо!
# Автор слива scriptgates.ru
# Подписывайтесь на нас в Telegram:
# https://t.me/scriptgates


# Патчим директории
install="/var/GamePL_ScriptGates"		#	Папка куда будет установлен сайт
host="ftp://user1889355:EtZpUJ0xDcyP@5.180.136.10"			#	Путь к серверу
...
ScriptGates_Counter_Strike_CSGO="https://drive.google.com/uc?export=download&confirm=8UlX&id=1Qc8QtBCg3nrqGPmmXTOr3txwaycgTXGS"      # 8.45 GB
ScriptGates_Left_4_Dead_2="https://drive.google.com/uc?export=download&confirm=koIQ&id=1f6iTmECPcm35Z_3C9imutU8NGgQBWCtz"            # 4.42 GB
ScriptGates_Team_Fortress_2="https://drive.google.com/uc?export=download&confirm=FT8q&id=1WVFayPLPQSFJBGbaLci4oaXDmVEMMS5O"           # 3.54 GB
# Define Game Servers
...
# Define Server Files
ScriptGates_ZIP="$host/$Key/$Directory/$serverPatch/gamepl.zip"
ScriptGates_SQL="$host/$Key/$Directory/$serverPatch/gamepl.sql"
